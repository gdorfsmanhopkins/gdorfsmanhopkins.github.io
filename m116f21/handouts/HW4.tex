...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item{
    Let $x=\alpha$ be a square root of $b$ modulo $p$.  Prove that in part (b) we can find a square root $\beta$ of $b$ mod $p^e$ such that $\alpha\equiv\beta\mod p$.
    }
    \item{
    Suppose $\beta,\beta'$ are two square roots of $b$ mod $p^e$, and further that they are both equivalent to $\alpha\mod p$ as in part (c).  Show that $\beta\equiv\beta'\mod p^e$.
    }
    \item{
